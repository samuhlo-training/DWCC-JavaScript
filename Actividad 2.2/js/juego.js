...
do {
  ...
  do {
    ...
    //solo podemos salir si hemos acertado o hemos cancelado algún cuadro
    if (salir == false)
      //mensaje de acierto
      alert("Acertaste! Intentos: " + cont);
    //pedimos confirmación al usuario para jugar otra vez si no
    //ha indicado que quiere salir
